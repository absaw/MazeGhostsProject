                    ...
                    if nearest_gh_maze_dist<=gh_maze_limit:
                        ...
                        for i in range(9):
                            ...
                            if 0 <= mark_r < n_row and 0 <= mark_c < n_col:
                                maze_marked_for_gh[mark_r][mark_c]=1
                        
                        # Recalculate the new path
                        latest_path_result=get_bfs_path(maze_marked_for_gh,n_row,n_col,(play_pos_r,play_pos_c),True)
