        ...
        while (n_maze > 0):
            ...
            for play_pos_r, play_pos_c in path:
                ...
                if nearest_gh_maze_dist<=gh_maze_limit:
                    ...
                    # maze_copy[[nearest_gh[0]]+1][nearest_gh[1]]=1
                    # maze_copy[[nearest_gh[0]]][nearest_gh[1]]=1
                    # maze_copy[[nearest_gh[0]]+1][nearest_gh[1]]=1
                    # maze_copy[[nearest_gh[0]]+1][nearest_gh[1]]=1
                    for i in range(0,4):
                        maze_copy=maze[i][0]
                    ...
                    if latest_path_result[0]:
                        ...
                        path.append((play_next_r, play_next_c))
                    # latest_path_result=get_bfs_path(maze,n_row,n_col,(play_next_r,play_next_c),True)
                    # if latest_path_result[0]:
                    #     latest_path=latest_path_result[1][1:]
                    # else:
