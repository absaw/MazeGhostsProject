...
if __name__ == "__main__":
    ...
    p_1 = mp.Process(target=agent_three, args=(1, 1, "Process 1 -- 10 mazes --10 sims"))
    p_11 = mp.Process(target=agent_three, args=(11, 11, "Process 11--10 mazes --10 sims"))
    p_21 = mp.Process(target=agent_three, args=(21, 21, "Process 21 -- 10 mazes --10 sims "))
    p_31 = mp.Process(target=agent_three, args=(31, 31, "Process 31 -- 10 mazes --10 sims "))
