    ...
    for i_ghost in range(1, n_ghost+1,5):
        ...
        while (n_maze>0):
            ...
            if is_init_path_valid:
                ...
                ghost_position,maze,play_next_r,play_next_c,nearest_ghost=run_away_from_ghost(walk,ghost_position,n_row,n_col,maze,0,0)
            ...
            for play_pos_r, play_pos_c in path:
                ...
                if latest_path[0]:#contains True/False : if there exists a path from player to goal, 
                    ...
                    ghost_position,maze,play_next_r,play_next_c,nearest_ghost=run_away_from_ghost(walk,ghost_position,n_row,n_col,maze,play_pos_r,play_pos_c)
                    path.append((play_next_r,play_next_c))
